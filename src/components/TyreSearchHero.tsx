      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        >
          ...
          <div className="mt-8 text-center">
            <img
              src={tyreSizeGuide}
              alt="How to read tyre sizes"
              className="mx-auto w-full max-w-md rounded-xl border border-gray-700 shadow-lg"
            />
            <p className="text-sm text-gray-400 mt-2">
              Example guide to help you identify tyre size numbers on your tyre.
            </p>
          </div>
        </motion.div>
      </section>
...
{hasSearched && (
  ...
  >
    <motion.section
      ...
      className="w-full max-w-5xl bg-[#1A1A1A] rounded-2xl overflow-hidden shadow-2xl p-6 relative"
    >
      {/* Close Button */}
      <button
